...
async function GetData() {
    const responsemock = await fetch("https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/Front-End+V2/P5+Javascript+&+Accessibility/FishEyeData.json")
        if (responsemock.ok) {
